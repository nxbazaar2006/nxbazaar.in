...
export function StateCombobox({
  ...
  const filteredStates = INDIAN_STATES.filter((state) =>
    state.name.toLowerCase().includes(search.trim().toLowerCase())
  );
        ...
        >
          <div className="flex items-center gap-2 truncate">
            ...
            <span className="truncate">
              {selectedState ? selectedState.name : <span className="text-slate-400">Select State...</span>}
            </span>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-slate-400">({state.type === "UNION_TERRITORY" ? "UT" : "State"})</span>
                      </div>
